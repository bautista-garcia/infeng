...
QUANT_LINEAR_KERNELS = {
    ...
    ("Q5_K", 4096, 8192): ("q5_k_k4096_n8192_decode_r2_tg64", "q5_k_k4096_n8192_prefill", 64, 4),
    ...
    ("IQ4_XS", 4096, 12288): ("iq4_xs_k4096_n12288_decode_r2_tg128", "iq4_xs_k4096_n12288_prefill", 128, 8),
}
